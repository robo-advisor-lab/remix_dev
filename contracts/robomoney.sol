...
contract RoboMoneyAlpha is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    ...
    constructor(address initialOwner)
        ERC20("RoboMoney Alpha", "RBM-A")
        ERC20Permit("RoboMoney Alpha")
    ...
    function rebase(int256 rebaseRate) external onlyOwner updateReward(address(0)) {
        ...
        if (rebaseRate > 0) {
            ...
            uint256 mintAmount = (currentTotalSupply * uint256(rebaseRate)) / 1e6; // rebaseRate is in ppm
